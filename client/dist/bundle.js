...
/******/ 	var hotCurrentHash = "952aaa1f2fd81c976a7c"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _login = __webpack_require__(/*! ui/components/login */ 187);
	...
	var App = function (_React$Component) {
	    ...
	    function App() {
	        ...
	        _axios2.default.post('http://localhost:8080/sso', {
	            companyCode: 'test',
	            hashType: 'md5'
	        }).then(function (res) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Render = __webpack_require__(/*! react-dom */ 38).Render;
	var axios = __webpack_require__(/*! axios */ 168);
	var stompClient = equire('../../websocket-listener');
	...
	var Login = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        stompClient.register([{ route: '/topic/ssoList', callback: this.websocketTest }]);
	    },
	
	    websocketTest: function websocketTest(message) {
	    ...
	    getSso: function getSso() {
	        axios.get("http://localhost:8080/api/sso").then(function (data) {
	    ...
	    login: function login(username, password) {
	        // axios.post('http://localhost:8080/signAction', {
	        //     username: username,
	        //     password: password
	    ...
	    logout: function logout() {
	        axios.delete('http://localhost:8080/api/session').then(function (data) {
	            return console.log(data);
	        }).catch(function (err) {
	            return console.log(err);
	        });
	    ...
	    sessionCheck: function sessionCheck() {
	        axios.get('http://localhost:8080/api/session').then(function (data) {
